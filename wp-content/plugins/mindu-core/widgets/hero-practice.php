...
class Mindu_Hero_Practice extends \Elementor\Widget_Base
{
    ...
    protected function register_controls_section()
    {
        ...
        $this->add_control(
            'description',
            [
                'label' => esc_html__('Description', 'mindu-core'),
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'rows' => 10,
                'default' => esc_html__('Default description', 'mindu-core'),
                'placeholder' => esc_html__('Type your description here', 'mindu-core'),
            ]
        );
        ...
        $this->add_control(
            'text_align',
            [
                'label' => esc_html__('Alignment', 'mindu-core'),
                'type' => \Elementor\Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => esc_html__('Left', 'mindu-core'),
                        'icon' => 'eicon-text-align-left',
                    ],
                    'center' => [
                        'title' => esc_html__('Center', 'mindu-core'),
                        'icon' => 'eicon-text-align-center',
                    ],
                    'right' => [
                        'title' => esc_html__('Right', 'mindu-core'),
        ...
        $this->add_control(
            'find_courses_button_text',
            [
                'label' => esc_html__('Primary Button Text', 'mindu-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Find Courses', 'mindu-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Primary Button Link', 'mindu-core'),
                'type' => \Elementor\Controls_Manager::URL,
                'placeholder' => esc_html__('https://your-link.com', 'mindu-core'),
                'show_external' => true,
                'default' => [
                    'url' => '',
                    'is_external' => false,
        ...
        $this->add_control(
            'explore_button_text',
            [
                'label' => esc_html__('Secondary Button Text', 'mindu-core'),
                'type' => \Elementor\Controls_Manager::TEXT,
        ...
        $this->add_control(
            'explore_button_link',
            [
                'label' => esc_html__('Secondary Button Link', 'mindu-core'),
                'type' => \Elementor\Controls_Manager::URL,
                'placeholder' => esc_html__('https://your-link.com', 'mindu-core'),
                'show_external' => true,
                'default' => [
    ...
    protected function register_style_section()
    {
        ...
        $this->add_control(
            'title_color',
            [
                'label' => esc_html__('Text Color', 'mindu-core'),
...
?>
        ...
        <div class="tp-hero-spacing z-1 tp-hero-overly p-relative bg-position" data-background="assets/img/hero/thumb.jpg">
                    ...
                    <div class="col-xl-7">
                        <div class="tp-hero-content mb-40">
                            ...
                            <h2 class="tp-hero-title mb-25 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".5s"><?php echo mc_kses($settings['title']); ?> <span class="p-relative">Today
                                    <span class="p-absolute shape">
                                        <svg width="229" height="24" viewBox="0 0 229 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M219.426 20.8301C123.148 -7.68076 38.838 10.2214 9.2819 20.6396C6.72121 21.5422 3.08611 24.1509 1.16266 22.9493C-0.760788 21.7476 -0.244205 17.1907 2.31648 16.2881C34.9011 4.8023 124.185 -13.6634 225.153 16.0976C227.938 16.8398 228.914 21.352 227.332 22.6588C225.75 23.9657 222.211 21.5723 219.426 20.8301Z" fill="currentColor" />
                                        </svg>
                                    </span>
                                </span></h2>
                            <p class="tp-hero-dec mb-30 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".6s"><?php echo mc_kses($settings['description']); ?></p>
                            <a href="<?php echo mc_kses($settings['find_courses_button_link']['url']); ?>" class="tp-btn tp-btn-square wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".7s" <?php if ($settings['find_courses_button_link']['is_external']): ?> target="_blank" <?php endif; ?>>
                                <?php echo mc_kses($settings['find_courses_button_text']); ?>
                                <span class="ml-8">
                            ...
                            <div class="tp-hero-explore mt-115 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".8s">
                                <a href="<?php echo mc_kses($settings['explore_button_link']['url']); ?>" class="tp-hero-btn" <?php if ($settings['explore_button_link']['is_external']): ?> target="_blank" <?php endif; ?>>
                                    ...
                                    <?php echo mc_kses($settings['explore_button_text']); ?>
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="d-flex justify-content-xl-end mb-40">
                            <div class="tp-hero-video wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".6s">
                                <video loop muted autoplay playsinline>
                                    <source src="https://html.aqlova.com/videos/mindu/video.mp4" type="video/mp4">
                                </video>
                                <a href="#" class="tp-hero-video-btn d-flex align-items-center justify-content-between">
                                    Innovate smart skills for learning
                                    <span>
