<?php
/**
 * Colorpicker (user meta)
 *
 * Sibling of metaboxes/fields/colorpicker.php — wrapped in a <tr> for the
 * user-profile form-table, and reads/writes user_meta instead of post_meta.
 * The tm-colorpicker-input class is picked up by the shared field runtime
 * (assets/js/tpmeta-fields.js) which initialises wpColorPicker on it.
 *
 * @var string $id
 * @var string $label
 * @var string $default
