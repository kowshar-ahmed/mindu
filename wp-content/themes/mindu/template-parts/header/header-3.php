                ...
                <div class="col-lg-6">
                    <div class="tp-header-top-info d-flex align-items-center">
                        <span class="mr-30 d-inline-block">
                            ...
                            Call us:
                            <a href="tel:256856963">256 856 963</a>
                        </span>
                        <span>
                            ...
                            Email:
                            <a href="mailto:mindu@gmail.com">mindu@gmail.com</a>
                        </span>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="tp-header-top-info d-flex align-items-center justify-content-end">
                        <span>
                            ...
                            Open for Learning: Mon - Sat 8.00 - 18.00
                        </span>
            ...
            <div class="row align-items-center">
                <div class="col-xl-9 col-5">
                    <div class="tp-header-2-left d-flex align-items-center">
                        <div class="tp-header-logo mr-100">
                            <a href="index.html">
                                <img width="85" src="assets/img/logo/logo.png" alt="">
                            </a>
                        </div>
                            ...
                            <nav class="tp-mobile-menu-active">
                                <ul>
                                    <li class="has-dropdown">
                                        ...
                                        <ul class="sub-menu">
                                            <li><a href="index.html">Online Academy</a></li>
                                            <li><a href="index-2.html">Online Course</a></li>
                                            <li><a href="index-3.html">Online Mentor</a></li>
                                        </ul>
                                    </li>
                                    <li class="has-dropdown">
                                        <a href="#">Pages</a>
                ...
                <div class="col-xl-3 col-7">
                    <div class="tp-header-option tp-header-2-option d-flex align-items-center justify-content-end">
                        ...
                        <a href="login.html" class="tp-btn ml-10 d-none d-sm-block">Login
                            <span class="ml-8">
