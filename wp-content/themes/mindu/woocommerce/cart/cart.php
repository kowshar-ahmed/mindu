...
<div class="row">
		...
		<div class="tp-cart-list mb-25 mr-30">
			<form class="woocommerce-cart-form" action="<?php echo esc_url(wc_get_cart_url()); ?>" method="post">
				...
				<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
					<thead>
						<tr>
							<th colspan="2" scope="col" class="product-name"><?php esc_html_e('Product', 'woocommerce'); ?></th>
								...
								<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
									...
									<td class="product-remove">
										...
										echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
											...
											sprintf(
												'<a role="button" href="%s" class="tp-cart-action-btn" aria-label="%s" data-product_id="%s" data-product_sku="%s"><svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<div class="col-xl-3 col-lg-4 col-md-6">
		<div class="tp-cart-checkout-wrapper">
			...
			<div class="cart-collaterals-custom">
				<?php
				/**
