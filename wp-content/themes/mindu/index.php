                        ...
                        <div class="tp-blog-item mb-40">
                            <div class="tp-blog-thumb overflow-hidden mb-35">
                                <a href="blog-details.html">
                                    <img class="w-100" src="assets/img/blog/postbox/thumb.jpg" alt="Mindu Blog Article - Expert Tips for Effective Online Education and Learning Success">
                                </a>
                            </div>
                            <div class="tp-blog-content">
                                ...
                                <h3 class="tp-blog-title fs-32 fw-600 mb-15">
                                    <a href="blog-details.html">Creating inclusive classrooms where<br> every student truly belongs.</a>
                                </h3>
                                <p class="fw-500">We foster a supportive learning environment where diversity is celebrated<br> every voice is respected and each student feels valued grow.</p>
                            </div>
                        </div>
                    </article>
                    <?php endif; ?>
