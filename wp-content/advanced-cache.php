...
// WP-Optimize advanced-cache.php (written by version: 4.5.5) (homeurl: http://localhost/mindu/) (abspath: C:\laragon\www\mindu/) (do not change this line, it is used for correctness checks)
...
$possible_plugin_locations = array(
	...
	'C:\laragon\www\mindu\wp-content\plugins\wp-optimize\cache',
);
...
if (false === $plugin_location) {
	...
	if (strcasecmp('http://localhost/mindu/', $protocol . '://' . $host . $request_uri) === 0) {
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', 'C:\laragon\www\mindu\wp-content\plugins\wp-optimize\cache/extensions');
}
